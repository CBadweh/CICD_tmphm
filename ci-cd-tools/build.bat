...
@REM Set the Toolchain and Environment
...
@REM set "version_file=..\App\gpio-app\version.h"
@REM set "version_file=..\Core\Src\version.h"

@REM if [%BUILD_TAG%]==[] goto :do_make
if "%BUILD_TAG%"=="" goto :do_make

@REM echo #ifndef _VERSION_H_ >"%version_file%"
@REM echo #define _VERSION_H_ >>"%version_file%"
@REM echo #define VERSION "%BUILD_TAG%-%build_type%" >>"%version_file%"
@REM echo #endif >>"%version_file%"
